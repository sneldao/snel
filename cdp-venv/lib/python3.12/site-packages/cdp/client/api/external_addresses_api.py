...
class ExternalAddressesApi:
    ...
    def broadcast_external_transaction(
        self,
        network_id: Annotated[StrictStr, Field(description="The ID of the network the external address belongs to.")],
        address_id: Annotated[StrictStr, Field(description="The onchain address of the transaction sender.")],
        ...
        :param network_id: The ID of the network the external address belongs to. (required)
        :type network_id: str
        :param address_id: The onchain address of the transaction sender. (required)
        :type address_id: str
        :param broadcast_external_transaction_request: (required)
        :type broadcast_external_transaction_request: BroadcastExternalTransactionRequest
        ...
        _param = self._broadcast_external_transaction_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BroadcastExternalTransaction200Response",
        }
    ...
    @validate_call
    def broadcast_external_transaction_with_http_info(
        self,
        network_id: Annotated[StrictStr, Field(description="The ID of the network the external address belongs to.")],
        address_id: Annotated[StrictStr, Field(description="The onchain address of the transaction sender.")],
        broadcast_external_transaction_request: BroadcastExternalTransactionRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BroadcastExternalTransaction200Response]:
        """Broadcast an arbitrary transaction.
    ...
    @validate_call
    def broadcast_external_transaction_without_preload_content(
        self,
        network_id: Annotated[StrictStr, Field(description="The ID of the network the external address belongs to.")],
        address_id: Annotated[StrictStr, Field(description="The onchain address of the transaction sender.")],
        broadcast_external_transaction_request: BroadcastExternalTransactionRequest,
    ...
    def _broadcast_external_transaction_serialize(
        self,
        network_id,
        address_id,
        ...
        if broadcast_external_transaction_request is not None:
            _body_params = broadcast_external_transaction_request
