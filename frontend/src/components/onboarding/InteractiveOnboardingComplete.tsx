...
// ======== Onboarding Content ========
  ...
  /* ------------------------------------------------------------------
   *  SCAFFOLDS – to be fully implemented in the next incremental patch
   * ------------------------------------------------------------------ */
  ...
  const isStepCompleted = (stepId: string) => preferences.completedSteps.includes(stepId);
  ...
  // --- TEMP return until full UI patch is added ---
  return (
    <>
      {/* placeholder – real Drawer/UI comes next patch */}
...
export const InteractiveOnboardingComplete: React.FC<InteractiveOnboardingProps> = ({
  isOpen = false,
  onClose,
  initialStep,
